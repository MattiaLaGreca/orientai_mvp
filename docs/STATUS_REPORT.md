...
2.  **AdMob:** Creare le unità pubblicitarie reali su AdMob Console e sostituire gli ID di test in `lib/screens/chat_screen.dart`.
3.  **GDPR Consent:** Implementare UMP SDK per la gestione del consenso (Pending).
