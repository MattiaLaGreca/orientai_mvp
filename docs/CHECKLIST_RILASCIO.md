...
*   [x] **Privacy Policy:** Generare e ospitare una Privacy Policy (es. su GitHub Pages o Iubenda). Deve citare l'uso di Firebase, AdMob e Gemini AI.
...
*   [ ] **Keystore:** Generare il file `.jks` per la firma dell'APK/AAB. (Passaggio manuale, vedi [MANUALE_RILASCIO.md](MANUALE_RILASCIO.md)). **NON committare questo file su git.**
*   [ ] **`key.properties`:** Configurare il file per referenziare la keystore, ed escluderlo dal version control. (Passaggio manuale, vedi [MANUALE_RILASCIO.md](MANUALE_RILASCIO.md)).
