...
class DatabaseService {
  ...
  Future<void> saveUserProfile(String name, String school, String interests) async {
    ...
    // 🔒 Sentinel Security: Backend Validation for Profile Data
    final nameError = Validators.validateName(name);
    if (nameError != null) throw OrientAIDataException(nameError);

    final interestsError = Validators.validateInterests(interests);
    if (interestsError != null) throw OrientAIDataException(interestsError);
